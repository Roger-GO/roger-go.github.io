...
const InfiniteSlider = () => {
  ...
  const allImages = [
    ...
    { src: '/images/screenshot-1.png', alt: 'Research Visualization 1', aspectRatio: 4/3 },
    { src: '/images/screenshot-2.png', alt: 'Research Visualization 2', aspectRatio: 16/9 },
    { src: '/images/screenshot-3.png', alt: 'Research Visualization 3', aspectRatio: 3/2 },
    { src: '/images/screenshot-4.png', alt: 'Research Visualization 4', aspectRatio: 16/9 },
    { src: '/images/screenshot-5.png', alt: 'Research Visualization 5', aspectRatio: 4/3 },
    { src: '/images/screenshot-6.png', alt: 'Research Visualization 6', aspectRatio: 16/9 },
    { src: '/images/screenshot-7.png', alt: 'Research Visualization 7', aspectRatio: 3/2 },
    { src: '/images/screenshot-8.png', alt: 'Research Visualization 8', aspectRatio: 16/9 },
    { src: '/images/screenshot-9.png', alt: 'Research Visualization 9', aspectRatio: 4/3 },
    { src: '/images/screenshot-10.png', alt: 'Research Visualization 10', aspectRatio: 16/9 },
    { src: '/images/screenshot-11.png', alt: 'Research Visualization 11', aspectRatio: 3/2 },
    { src: '/images/screenshot-12.png', alt: 'Research Visualization 12', aspectRatio: 16/9 },
    { src: '/images/screenshot-13.png', alt: 'Research Visualization 13', aspectRatio: 4/3 },
    { src: '/images/screenshot-14.png', alt: 'Research Visualization 14', aspectRatio: 16/9 },
    { src: '/images/screenshot-15.png', alt: 'Research Visualization 15', aspectRatio: 3/2 },
    { src: '/images/screenshot-16.png', alt: 'Research Visualization 16', aspectRatio: 16/9 },
    { src: '/images/screenshot-17.png', alt: 'Research Visualization 17', aspectRatio: 4/3 },
